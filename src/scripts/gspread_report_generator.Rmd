---
title: "gSpreadComp Genome Risk Assesment Report"
output:
...
```{r, include=FALSE}
#setwd("~/pCloudDrive/Chapter3_DietMAGs/mspread_test_out")
#setwd("P:/Chapter3_DietMAGs/mspread_test_out")
#setwd("/Users/jonask/pCloud Drive/Chapter3_DietMAGs/mspread_test_out")
library(dplyr)
library(knitr)
library(DT)
library(rmdformats)
...
## Plasmid-mediated HGT events {.tabset} 
